...
if __name__ == "__main__":
    ...
    for latency_file in latency_files:
        ...
        data_lat = replace_none_with_random_average_lat(data_lat)
    ...
    for iops_file in iops_files:
        ...
        data_iops = convert_dict_values_to_Yk(data_iops)
        data_iops = replace_none_with_random_average_iops(data_iops)
